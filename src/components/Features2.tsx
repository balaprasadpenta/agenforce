...
const data: dataProps[] = [
  {
    ...
    smallCard: (
      <div className="flex gap-x-2 border-2 rounded-lg p-1 font-bold text-sm">
        <IconClock stroke={2} />
        <p>15s</p>
      </div>
    ),
  ...
  {
    icon: <IconDevicesCheck stroke={2} />,
    text: "SEO Audit",
    smallCard: (
      <div>
        <p>FAILED</p>
